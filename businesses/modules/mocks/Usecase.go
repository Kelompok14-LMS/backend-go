...
func (_m *Usecase) Create(moduleDomain *modules.Domain) error {
...
func (_m *Usecase) Delete(moduleId string) error {
...
func (_m *Usecase) FindById(moduleId string) (*modules.Domain, error) {
	ret := _m.Called(moduleId)
...
func (_m *Usecase) Update(moduleId string, moduleDomain *modules.Domain) error {
